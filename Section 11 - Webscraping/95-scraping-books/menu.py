...
def print_best_books():
    ...
    best_books = sorted(books, key=lambda x: (x.rating * -1, x.price))[:10]  # Sorted ascending by default. Sort by rating, then by price
    for book in best_books:
        print(book)


def print_worst_books():
    logger.info('Finding worst books by rating...')
